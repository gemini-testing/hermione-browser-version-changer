...
All bug fixes and new features should go to the [`master`](https://github.com/gemini-testing/testplane-browser-version-changer/tree/master) branch.
...
1. [Search](https://github.com/gemini-testing/testplane-browser-version-changer/issues) for same issues on github in order to prevent duplicates
